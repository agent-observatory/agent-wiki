...
card(368,468,288,188,'세션별 묶음 · 청킹',['미처리 조각을 모아 읽기','원문 위치 · 해시 고정','토큰 예산에 맞춰 분할'],'ingest','tabler-cpu')
...
card(1330,890,290,96,'다음 처리 위치',['새 기록은 다음 묶음으로'],'ops','tabler-clipboard-check')
