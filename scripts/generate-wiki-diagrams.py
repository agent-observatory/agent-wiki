...
card(72,825,366,425,'Agent Wiki CLI',['한 번 설치 · 인증·설정 통합'],'ops','tabler-terminal-2')
icon('tabler-clipboard-check',92,937,26);text(130,959,'조회 · 내장 Skill',23,True)
text(92,994,'wiki recall · wiki search',18)
a('<path d="M92 1020 H418" stroke="#929EAD"/>')
icon('tabler-cloud-upload',92,1055,26);text(130,1077,'백그라운드 수집',23,True)
text(92,1115,'wiki collector · 기본 10분',18)
text(92,1146,'마스킹 · 텍스트·이미지 분리',18)
text(92,1177,'압축 증분 직접 전송',18)
...
for n,y,name,who,title,example,role in rows:
 ...
 if n==5:
  card(456,y+16,290,114,'내장 조회 Skill',['조회 판단 · 근거 선택'],'ai','tabler-clipboard-check')
  ...
  card(1136,y+16,354,114,'Agent Wiki CLI',['조회 명령 · 내장 Skill'],'app','tabler-terminal-2')
 else:
