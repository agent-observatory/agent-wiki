...
card(368,468,288,188,'이번 수집분 · 처리 범위',['시작할 때 범위 고정','원문 위치 · 해시 유지','내부에서 묶음 · 청킹'],'ingest','tabler-cpu')
...
card(1330,890,290,96,'다음 처리 위치',['새 증분은 다음 처리로'],'ops','tabler-clipboard-check')
