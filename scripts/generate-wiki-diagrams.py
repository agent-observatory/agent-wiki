...
card(40,135,335,190,'검색어 준비',['PostgreSQL은 → 원형도 검색','별칭 · 검색어별 대안 묶기','중복 검색어는 한 번 계산'],'app','tabler-terminal-2')
...
card(1180,135,340,190,'Context 반환',['관련 본문 구간 발췌','고정 Version · 원문 근거','최대 6개 · 반환 예산 적용'],'app','tabler-book-2')
