...
- OCI A1 Compute VM 1대·2 OCPU·12GB는 유지한다. Compose는 Caddy·Next.js·API·Worker·PostgreSQL 5개다. CPU는 공유하고 Worker만 최대 0.5 CPU·2GB이며 Free 동시성 1, BYOK는 Workspace별 최대 5로 제한한다.
