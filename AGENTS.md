...
- 현재 메뉴는 L3 · Knowledge → L1–L2 · Sources → 설정 순서다. Sources는 Raw Sources·Curation·수집 상태, Knowledge는 지식 목록·반영 이력을 포함한다. L1·L2 내부 책임은 유지하며 페이지·검색 조건을 URL로 유지한다. UI는 shadcn을 기본으로 한다.
